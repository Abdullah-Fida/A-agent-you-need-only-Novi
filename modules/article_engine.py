...
class ArticleAgent:
    ...
    async def _write_evergreen_body(self, title: str, angle: str,
        ...
        user_prompt = (
            ...
            f"SECTION: {category}\n\n"
            "Structure it as:\n"
            "1. A \"Key points\" <ul> of three short bullets, FIRST, before "
            "any prose. Each bullet is one plain sentence that answers part "
            "of the title on its own.\n"
            "2. A direct opening that answers the question in the title within "
            "the first two sentences. No throat-clearing, no 'in today's world'.\n"
            "3. Four to six <h2> sections that build understanding in order - "
            "the mechanism first, then the implications, then the practical part.\n"
            "4. A <ul> of practical takeaways a reader can act on.\n"
            "5. A closing paragraph on what is still uncertain or debated.\n\n"
