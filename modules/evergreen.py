...
TOPIC_BANK: List[Dict[str, str]] = [
    ...
    {"category": "crypto", "photo": "hardware wallet security",
    ...
    {"category": "crypto", "photo": "data analysis charts screen",
    ...
    {"category": "crypto", "photo": "blockchain network technology",
    ...
    {"category": "crypto", "photo": "cryptocurrency exchange trading",
    ...
    {"category": "pakistan", "photo": "tax documents calculator",
    ...
    {"category": "pakistan", "photo": "laptop remote work desk",
    ...
    {"category": "business_markets", "photo": "stock market chart graph",
    ...
    {"category": "tech_ai", "photo": "computer screen code programming",
    ...
    {"category": "tech_ai", "photo": "smartphone privacy security",
    ...
    {"category": "world_news", "photo": "banknotes currency cash",
