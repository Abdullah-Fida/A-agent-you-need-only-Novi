...
TOPIC_BANK: List[Dict[str, str]] = [
    ...
    {"category": "crypto", "photo": "server rack",
    ...
    {"category": "business_markets", "photo": "calculator",
    ...
    {"category": "tech_ai", "photo": "laptop screen",
